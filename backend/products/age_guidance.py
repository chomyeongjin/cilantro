...
def age_guidance(age):
    ...
    if age in ('kids','teens'):
        ...
        return dict(title='성장기 영양 근거 · 어린이용 제품 추천과 구분',notice=general+' 정확한 만 나이와 제품의 소아용 표시가 필요합니다. 연령별 목록은 대상 연령·용량 검토를 마친 제품만 연결합니다.',items=cards,reviewedAt='2026-09-20')
